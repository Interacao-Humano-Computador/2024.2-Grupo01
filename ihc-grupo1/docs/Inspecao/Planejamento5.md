...
| ID  | Descrição                                                                                                          | Avaliação | Autor                                    |
| --- | ------------------------------------------------------------------------------------------------------------------ | --------- | ---------------------------------------- |
| 13   | O artefato utiliza o framework DECIDE para realização do Planejamento da Avaliação do Storyboard?                  |           | [Davi Nobre](https://github.com/Jagaima) |
...
## Inspeção 04: Planejamento Resultado da avaliação do Storyboard

| ID  | Descrição                                                                                           | Avaliação | Autor           |
| --- | --------------------------------------------------------------------------------------------------- | --------- | --------------- |
| 23  | O artefato apresenta uma seção de Introdução?                                                       | -         | Carla e Eduarda |
| 24  | O artefato inclui uma Bibliografia ou Referências Bibliográficas?                                   | -         | Carla e Eduarda |
| 25  | Há um Histórico de Versões detalhado com ID, descrição das versões, data, autores e revisores?      | -         | Carla e Eduarda |
| 26  | Todos os textos estão escritos seguindo a norma padrão da língua?                                   | -         | Carla e Eduarda |
| 27  | As tabelas e imagens são mencionadas no texto, possuem legendas e fontes?                           | -         | Carla e Eduarda |
| 28  | O planejamento define claramente os objetivos e o escopo da avaliação?                              | -         | Carla e Eduarda |
| 29  | O planejamento descreve o método de avaliação de forma estruturada?                                 | -         | Carla e Eduarda |
| 30  | Há instruções claras sobre como registrar sugestões de melhorias?                                   | -         | Carla e Eduarda |
| 31  | Existe uma seção específica para registrar o feedback dos usuários?                                 | -         | Carla e Eduarda |
| 32  | O planejamento descreve como será realizada a análise da interação do usuário com o artefato?       | -         | Carla e Eduarda |
| 33  | O planejamento inclui um tópico para sumarizar os principais resultados?                            | -         | Carla e Eduarda |
| 34  | Está explícito que os resultados precisam considerar as questões que motivaram o estudo?            | -         | Carla e Eduarda |
| 35  | O planejamento segue um padrão consolidado para artefatos semelhantes?                              | -         | Carla e Eduarda |
